...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Dish[] mainCourses = {
                new Dish("Black pepper and tomato salad", "Fresh black pepper and tomato served on a bed of lettuce", 1399),
                new Dish("Tomato and carrot salad", "Fresh tomato and carrot served on a bed of lettuce", 1299),
